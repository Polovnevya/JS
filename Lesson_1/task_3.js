...
console.log(10 + 10 + +"10");
/*10+10=20 +  (+"10) = 30, унарный плюс производит приведение строки к числовому типу*/
console.log(10 / -"");
/*-Infinity результат отрицательная бесконечность т.к. производится попытка разделить на пустую строку с унарным минусом*/
console.log(10 / +"2,5");
/*NaN т.к. унарный плюс не может произвести приведение типов изза того что разделитель  в JS это точка*/
